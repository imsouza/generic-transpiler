...
union YYSTYPE
{
#line 20 "src/scopes.y"

    int int_val;
    std::string *str_val;

#line 144 "obj/scopes.tab.c"
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* input: input line EOL  */
#line 40 "src/scopes.y"
                 {
    if (current_indent > 0) {
